...
import { SchedulerExecutionHistory } from "./SchedulerExecutionHistory";
...
export function SchedulerPanel() {
  ...
  // Execution history for expanded jobs
  const activeHistoryJobId = expandedJobId;
  const { data: historyData, isLoading: historyLoading } = useSchedulerJobHistory(activeHistoryJobId);
